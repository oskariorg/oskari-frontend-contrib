...
Oskari.clazz.define('Oskari.mapframework.bundle.downloadBasket.Bundle', function () {
    ...
    'source': {
        ...
        'scripts': [{
            ...
            'src': '../../bundles/download-basket/instance.js'
        }, {
            'type': 'text/javascript',
            'src': '../../bundles/download-basket/Flyout.js'
        }, {
            'type': 'text/javascript',
            'src': '../../bundles/download-basket/Cropping.js'
        }, {
            'type': 'text/javascript',
            'src': '../../bundles/download-basket/Basket.js'
        }, {
            'type': 'text/javascript',
            'src': '../../bundles/download-basket/Tile.js'
        }, {
            'type': 'text/css',
            'src': '../../bundles/download-basket/resources/scss/style.scss'
        }],

        'locales': [{
            'lang': 'en',
            'type': 'text/javascript',
            'src': '../../bundles/download-basket/resources/locale/en.js'
        }, {
            'lang': 'fi',
            'type': 'text/javascript',
            'src': '../../bundles/download-basket/resources/locale/fi.js'
        }, {
            'lang': 'sv',
            'type': 'text/javascript',
            'src': '../../bundles/download-basket/resources/locale/sv.js'
        }]
    },
    'bundle': {
        'manifest': {
